 ...
 * pulsing dot while the pipeline runs. Tooltip breaks down prompt/completion
 * tokens; clicking opens the /usage ledger.
 */
export function CostChip({
  ...
  return (
    <Tip tip={tip}>
      <Link
        href="/usage"
        className={`flex items-center gap-2 rounded-full border-[1.5px] bg-ink px-3.5 py-1.5 ${
